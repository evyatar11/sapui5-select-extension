/**
 * Select control extension.
 * 
 * This extension enables a default option "Add..." to the select, which opens a dialog to the user create a new option.
 * 
 * @public
 * @extends sap.m.Select
 * @author Tiago Quaini
 */
jQuery.sap.declare("sapui5-control-extension-demo.controls.Select");
jQuery.sap.require("sap.m.Select");
jQuery.sap.require("sap.m.SelectRenderer");

sap.m.Select.extend("sapui5-control-extension-demo.controls.Select", {
